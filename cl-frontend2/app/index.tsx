...
import { Image, type ImageStyle, View, ScrollView, Modal, Pressable } from 'react-native';
  ...
  return (
    ...
    >
      <View className="flex-1 bg-black/50 justify-center items-center p-4">
        <View className="bg-background rounded-2xl w-full max-w-4xl max-h-[85%] border border-border flex-row overflow-hidden">
          {/* Sidebar */}
